...
describe("transformFrontmatter", () => {
  describe("cursor", () => {
    ...
    it("passes array scope through for globs", () => {
      const result = transformFrontmatter(
        { description: "Test", scope: ["src/**", "lib/**"] },
        "cursor",
      );
  ...
  it("throws for unknown platform", () => {
    ...
    expect(() => transformFrontmatter({}, "unknown")).toThrow(
